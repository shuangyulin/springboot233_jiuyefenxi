        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否就业" prop="jiuyeTypes">
                        <el-select v-model="ruleForm.jiuyeTypes" :disabled="ro.jiuyeTypes" placeholder="请选择是否就业">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="是否就业" prop="jiuyeValue">
